...
export const updateProfile = async (req: Request, res: Response, next: NextFunction)=> {
    try{
        ...
        const avatarPath: string = req.file?.filename !== undefined ?  `/upload/users-data/${req.file?.filename}` : user.avatarUrl;
        ...
        const updatedUser = await User.findByIdAndUpdate(user._id, updatedUserDetails, { new: true, runValidators: true });
